        ...
        <div class="row px-xl-5">
            <div class="col-lg-3 d-none d-lg-block mt-2">
                ...
                <a href="" class="text-decoration-none ">
                    <span class=" h1  text-primary bg-dark px-2">BJ FOODs</span>
                </a>
            </div>
            <div class="col-lg-9">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            <div class="dropdown d-inline me-3">
                                <a class="btn btn-primary rounded dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
