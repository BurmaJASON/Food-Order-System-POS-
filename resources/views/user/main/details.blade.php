...
@section('content')
    ...
    <div class="container-fluid pb-5">
        <div class="row px-xl-5">
            <div class="text-black my-3" onclick="history.back()">
                ...
                <div class="owl-carousel related-carousel">
                    ...
                    <div class="product-item bg-light">
                        <div class="product-img position-relative overflow-hidden">
                            <img class="img-fluid w-100" src="{{ asset('storage/'.$p->image) }}" alt="" height="250px">
                            <div class="product-action">
                                <a class="btn btn-outline-dark btn-square" href=""><i class="fa fa-shopping-cart"></i></a>
                                <a class="btn btn-outline-dark btn-square" href="{{ route('user#pizzaDetails',$p->id) }}" title="Detail"><i class="fa fa-circle-info"></i></a>
                            </div>
                        </div>
                        <div class="text-center py-4">
                            <a class="h6 text-decoration-none text-truncate" href="{{ route('user#pizzaDetails',$p->id) }}">{{ $p->name }}</a>
